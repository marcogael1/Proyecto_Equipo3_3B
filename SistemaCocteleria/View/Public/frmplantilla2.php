...
<body>
	<header>
		<div class="logo">
			...
			<nav id="menu-area">
				<a href="http://LocalHost/SistemaCocteleria/?Controller=CatalogoController&Method=MostrarCatalogo">Inicio</a>
				<a href="http://LocalHost/SistemaCocteleria/?Controller=UserController&Method=inicio">Iniciar Sesion</a>
			</nav>
	</header>
