	...
	<main class="main-content">
		...
		<br></br>
			<div class="filtro-categoria">
				<form method="post"
					action="http://LocalHost/SistemaCocteleria/?Controller=CatalogoController&Method=MostrarCatalogoPorCategoriaNosesion">
					...
					foreach ($productos as $producto) {
						...
						<div class='item'>
							...
							<div class="form-group">
								<a href="#" onclick="confirmarSesion()">Ver detalle</a>
							</div>
						</div>
						<?php
						$contador++;
...
<script>
	function confirmarSesion() {
		if (confirm("Para comprar este producto necesitas iniciar sesion ¿Deseas hacerlo?")) {
			window.location.href = "http://LocalHost/SistemaCocteleria/?Controller=UserController&Method=Inicio";
		}
	}
</script>